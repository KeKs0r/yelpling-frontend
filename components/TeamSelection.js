...
export default class TeamSelection extends Component {
  ...
  render() {
    const { lineup, costs, replaceState } = this.props;
    ...
    return (
      <div>
        ...
        <PositionList players={grouped.get('GOAL')} position="GOAL" count={system.GOAL} selectPosition={this.selectPosition} selectPlayer={() => {}} />
        <PositionList players={grouped.get('DEF')} position="DEF" count={system.DEF} selectPosition={this.selectPosition} selectPlayer={() => {}} />
        <PositionList players={grouped.get('MID')} position="MID" count={system.MID} selectPosition={this.selectPosition} selectPlayer={() => {}} />
        <PositionList players={grouped.get('ATT')} position="ATT" count={system.ATT} selectPosition={this.selectPosition} selectPlayer={() => {}}/>
